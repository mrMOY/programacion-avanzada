...
function run(){
    ...
    paredes[0] = new cuadro(40,120,30,300,"gray");
    paredes[1] = new cuadro(225, 51,300, 30,"blue");
    paredes[2] = new cuadro(550,120,30,300,"gray");
    paredes[3] = new cuadro(225, 500,300,30,"yellow");
